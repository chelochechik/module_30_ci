...
@app.get(
    ...
    description="Сортировка списка рецептов: по ASC views, затем DESC cooking_time",
)
...
@app.get(
    ...
    description="Возвращает полную информацию о рецепте и увеличивает счетчик views",
)
